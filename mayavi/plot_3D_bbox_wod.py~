...
def main():
	...
	#bbox = '/home/success/Documents/rciServer/mnt/data/vras/data/gebreawe/Modified_Experiments/ST_PointRCNN_WOD/Teacher/tools/script/test_previous/DET/wod_train_mf1500_w3_p16384_agum_f1_0/10203656353524179475_7625_000_7645_000/per_sweep_annotations_amodal/tracked_object_labels_1507330244649398000.json'
	...
	'''
	pc = '/home/success/Documents/rciServer/mnt/beegfs/gpu/argoverse-tracking-all-training/argoverse-tracking/processed/source/training_all/f-5_5/f1500/mframe/train/0/lidar/PC_315968494620383000.ply'
	bbox = '/home/success/Documents/rciServer/mnt/beegfs/gpu/argoverse-tracking-all-training/argoverse-tracking/processed/source/training_all/f-5_5/f1500/mframe/train/0/per_sweep_annotations_amodal/tracked_object_labels_315968494620383000.json'
	'''
	pc = '/home/success/Documents/rciServer/mnt/beegfs/gpu/argoverse-tracking-all-training/WOD/WOD_ARGO/training/f-5_5/mframe/train/183829460855609442_430_000_450_000/lidar/PC_1520530528795071000.npy'
	bbox = '/home/success/Documents/rciServer/mnt/beegfs/gpu/argoverse-tracking-all-training/WOD/WOD_ARGO/training/f-5_5/mframe/train/183829460855609442_430_000_450_000/per_sweep_annotations_amodal/tracked_object_labels_1520530528795071000.json'
	...
	for k, label in enumerate (label_data): 
		...
		ry = Rotation.from_quat(q).as_euler('xyz')[-1]
		...
		bbox3d[k,6] = ry #(np.pi/2. -ry)
		bbox3d[k,7] = 1 #label['label_class']
		
	V.draw_scenes(
		points=pc, ref_boxes=bbox3d,ref_scores=None, ref_labels=None)
	mlab.show(stop=True)
